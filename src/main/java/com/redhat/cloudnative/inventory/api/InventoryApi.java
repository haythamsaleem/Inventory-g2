...
public interface InventoryApi {
    ...
    @ApiOperation(value = "Get all InventoryItems", nickname = "inventoryGet", notes = "", response = Object.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Should return an arry of InventoryItems", response = Object.class, responseContainer = "List") })
    ...
    @ApiOperation(value = "Get one InventoryItem", nickname = "inventoryItemIdGet", notes = "", response = InventoryItem.class, tags={  })
    @ApiResponses(value = { 
